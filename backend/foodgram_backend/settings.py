...
CSRF_TRUSTED_ORIGINS = ['https://foodgram.tech']
...
DJOSER = {
    ...
    'SERIALIZERS': {
        'user_create': 'users_app.serializers.UserCreateSerializer',
        'current_user': 'users_app.serializers.UserSerializer',
        'user': 'users_app.serializers.UserSerializer',
    },
    'PERMISSIONS': {
